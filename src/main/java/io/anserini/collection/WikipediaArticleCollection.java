 ...
 *
 */
public class WikipediaArticleCollection extends DocumentCollection
    implements SegmentProvider<WikipediaArticleCollection.Document> {
  private static final Logger LOG = LogManager.getLogger(WikipediaArticleCollection.class);
