 ...
 *
 */
public class WikipediaParagraphCollection extends DocumentCollection
    implements SegmentProvider<WikipediaParagraphCollection.Document> {
  private static final Logger LOG = LogManager.getLogger(WikipediaParagraphCollection.class);
  ...
  public class FileSegment extends BaseFileSegment<Document> {
    ...
    public boolean hasNext() {
      ...
      if (node == null) {
        ...
        bufferedRecord = new WikipediaParagraphCollection.Document(node.get("id").asText() + "_" + String.valueOf(iterParagraph.nextIndex()), iterParagraph.next());
