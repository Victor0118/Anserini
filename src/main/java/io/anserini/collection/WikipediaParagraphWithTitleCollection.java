 ...
 *
 */
public class WikipediaParagraphWithTitleCollection extends DocumentCollection
    implements SegmentProvider<WikipediaParagraphWithTitleCollection.Document> {
  private static final Logger LOG = LogManager.getLogger(WikipediaParagraphWithTitleCollection.class);
  ...
  public class FileSegment extends BaseFileSegment<Document> {
    ...
    private String title; // title of a document
    ...
    public boolean hasNext() {
      ...
      if (node == null) {
        ...
        bufferedRecord = new WikipediaParagraphWithTitleCollection.Document(node.get("id").asText() + "_" + String.valueOf(iterParagraph.nextIndex()), title + " . " + iterParagraph.next());
